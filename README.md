...
9. **Escena 3D.** Tres categorías más preparan una escena lista para usar:
   ...
   - **Túneles:** se crean donde un cerro cubre la pista con altura suficiente (altura libre + techo). Cada túnel es independiente y se arma con mallas separadas: *paredes*, *techo* (para texturas distintas), *veredas*, *boca de entrada* y *boca de salida*.
     ...
     - *Costado abierto*: cerrado, o abierto a la izquierda o a la derecha con *N pilares* (cubos estirados con el pivote en el centro de su base). Estos son los valores generales; al seleccionar un túnel (clic en 3D o en su nombre) su tarjeta permite darle un costado abierto y una cantidad de pilares propios, y *Usar valores generales* lo devuelve al general. Los ajustes se guardan con el proyecto.
