...
export function buildLayout(project, gpIn = {}) {
  ...
  if (isCtrl && Array.isArray(project.main.bridges) && project.main.bridges.length) {
    ...
    project.main.bridges.forEach((b, bIndex) => {
      ...
      bridges.push({ i0: j0, len: f, w: b.w, off: clamp(+b.off || 0, -1, 1), idx: bIndex, pa: null, pb: null, dirt: !!b.dirt, barrier: b.barrier !== false, dirtSide: b.dirtSide || 'both', barrierSide: b.barrierSide || 'both', uid: b.uid || null });
    });
  ...
  main.bridges = bridges.map((b) => {
    ...
    return { s0, s1, w: b.w, off: b.off || 0, idx: b.idx, dirt: b.dirt, barrier: b.barrier, dirtSide: b.dirtSide, barrierSide: b.barrierSide, uid: b.uid }; // camino de tierra (no por defecto) y barrera (sí) propios
  });
  main.id = 0;
  main.kind = 'main';
